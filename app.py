...
col5.metric("Trend","Bullish" if change > 0 else "Bearish")
...
["Overview","Technical Charts","Data","Machine Learning Model"]
)
...
This dashboard analyzes historical stock data and applies machine learning
